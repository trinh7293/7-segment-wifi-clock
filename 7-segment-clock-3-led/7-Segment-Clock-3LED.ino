/*
  ...
  Total of 86 LED's     3X7X4+2=86. 3 pixel/segment
...
STEPS TO ACTIVE 7SEGMENT CLOCK
if you use bin file (ino.bin and spiffs.bin)

1.hotspot setting 
*hotspot network or hotspot on another cellphone.
ssid  : DigitalClock
password : 12345678

2. TURN ON YOUR 7SEGMENT CLOCK (ESP8266)
...
#define WIFIMODE 2                            // 0 = Only Soft Access Point, 1 = Only connect to local WiFi network with UN/PW, 2 = Both
  ...
  const char* APssid = "7Segment-3Led";        
